...
| names | array | Array of names for objects with multiple names \* \*\* |
| designations | array | Array of official designations \* |
...
\* Returned for stars only

\*\* Returned for arabic parts only
